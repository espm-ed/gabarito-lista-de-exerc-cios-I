public class Exercicio04 {
    ...
    // este método verifica se o número é um palíndromo. Aqui estou usando apenas lógica de programação
    // não estou usando nenhum recurso mais elaborado da linguagem que vocês não conheçam
