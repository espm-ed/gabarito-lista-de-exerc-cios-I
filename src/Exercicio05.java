/* como todos já sabem, alguns exercícios tem várias formas de serem implementados. Algumas soluções
 * mais simples têm complexidade de tempo muito ruim. Neste exercício uma abordagem eficiente é calcular
 * o mínimo múltiplo comum (MMC) no intervalo.
 * 
 * no enunciado do exercício acabei colocando o resultado errado. Ao vocês executarem esse código consiguirão
 * verificar qual é a resposta correta.
 */
